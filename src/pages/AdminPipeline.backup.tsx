/**
 * BACKUP - AdminPipeline.tsx (versão com scrollbar nativa funcionando)
 * Data: 2025-12-22
 * Para restaurar: copie este conteúdo para AdminPipeline.tsx
 */
  ...
  return (
    <AdminLayout>
      <div className="h-full w-full max-w-full flex flex-col overflow-hidden">
        ...
        {/* Pipeline Board - Container com scroll horizontal nativo estilizado */}
        <div 
          className="pipeline-scroll flex-1 min-h-0 px-4 md:px-6 pb-4 overflow-x-auto overflow-y-hidden"
